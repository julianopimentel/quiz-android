 ...
 */
public class Denuncia extends SQLiteOpenHelper {
    ...
    private static final String Table_name = "denuncia";//name of table
    ...
    public Denuncia(Context context) {//constructor
