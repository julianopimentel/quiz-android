 ...
 */
public class Redesocial extends SQLiteOpenHelper {
    ...
    private static final String Table_name = "redesocial";//name of table
    ...
    public Redesocial(Context context) {//constructor
