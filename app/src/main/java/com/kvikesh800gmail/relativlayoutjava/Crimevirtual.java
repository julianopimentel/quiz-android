 ...
 */
public class Crimevirtual extends SQLiteOpenHelper {
    ...
    private static final String Table_name = "crimevirtual";//name of table
    ...
    public Crimevirtual(Context context) {//constructor
