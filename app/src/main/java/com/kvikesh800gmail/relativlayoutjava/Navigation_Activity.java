...
public class Navigation_Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressBar.setMessage("Obtendo Perguntas ...");//Title shown in the progress bar
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_scorecard) {
            ...
            Intent chooser = Intent.createChooser(intent, "Compartilhamento");
            ...
            intent.setData(Uri.parse("mailto:"));
            String[] recipents = {"juliano_pimentel@live.com"};
            intent.setType("message/rfc822");
            intent.putExtra(Intent.EXTRA_EMAIL, recipents);
            intent.putExtra(Intent.EXTRA_SUBJECT, "Quiz Reviews");
