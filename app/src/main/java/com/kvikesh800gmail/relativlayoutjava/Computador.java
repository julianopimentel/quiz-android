 ...
 */
public class Computador extends SQLiteOpenHelper {
    ...
    private static final String Table_name = "computador";//name of table
    ...
    public Computador(Context context) {//constructor
