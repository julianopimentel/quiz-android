 ...
 */
public class Privacidade extends SQLiteOpenHelper {
    ...
    private static final String Table_name = "privacidade";//name of table
    ...
    public Privacidade(Context context) {//constructor
