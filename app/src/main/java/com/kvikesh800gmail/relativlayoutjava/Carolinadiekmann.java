 ...
 */
public class Carolinadiekmann extends SQLiteOpenHelper {
    ...
    private static final String Table_name = "carolinadiekmenn";//name of table
    ...
    public Carolinadiekmann(Context context) {//constructor
