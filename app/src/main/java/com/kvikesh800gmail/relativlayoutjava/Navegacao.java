 ...
 */
public class Navegacao extends SQLiteOpenHelper {
    ...
    private static final String Table_name = "navegacao";//name of table
    ...
    public Navegacao(Context context) {//constructor
