 ...
 */
public class Prevencao extends SQLiteOpenHelper {
    ...
    private static final String Table_name = "prevencao";//name of table
    ...
    public Prevencao(Context context) {//constructor
