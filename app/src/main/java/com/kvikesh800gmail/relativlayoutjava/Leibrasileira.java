 ...
 */
public class Leibrasileira extends SQLiteOpenHelper {
    ...
    private static final String Table_name = "leibrasileira";//name of table
    ...
    public Leibrasileira(Context context) {//constructor
